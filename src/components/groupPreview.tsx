...
export const GroupPreview: React.FC<Props> = ({ section, group, images, displayName }) => {
  ...
  return (
    <Link href={`/sections/${section}/${group}`}>
      ...
      >
        <h2 className="text-2xl text-chocolate font-semibold mb-4 capitalize group-hover:text-powder transition">
          {displayName}
        </h2>

        <div className="grid grid-cols-3 gap-4 items-stretch transition duration-300 hover:scale-105">
